class VMWriter:
    ...
    def write_call(self, class_name: str, subroutine_name: str, n_args: int) -> None:
        self.output.append(f"call {class_name}.{subroutine_name.get_token()} {n_args}")
    
    def write_function(self, class_name: str, subroutine_name: str, n_vars: int) -> None:
        self.output.append(f"function {class_name.get_token()}.{subroutine_name.get_token()} {n_vars}")
    ...
    def write_arithmetic(self, op: str) -> None:
        if op == "+":
            ...
            # TODO: handle other arithmetic operations. 
            assert False
